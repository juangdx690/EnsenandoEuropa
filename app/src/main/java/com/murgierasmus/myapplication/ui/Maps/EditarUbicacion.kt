...
class EditarUbicacion : AppCompatActivity(), OnMapReadyCallback,
    ...
    private fun createMarker() {
        ...
        editar = bundle.getStringExtra("EDITAR")
        val coordinates = LatLng(datosCiudad2Item.UbicacionLng1, datosCiudad2Item.UbicacionLng2)
        ...
        val marker: MarkerOptions = MarkerOptions().position(coordinates!!)
            .title(MainActivity.context.getString(R.string.mapafinal_destino))

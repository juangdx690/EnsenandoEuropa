...
import com.murgierasmus.myapplication.databinding.ItemCiudadAdminBinding
...
class CiudadViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val binding = ItemCiudadAdminBinding.bind(view)
    ...
    val btnEditar = binding.btnEditar
    ...
    fun render(datosCiudadModel: DatosCiudad2Item, position: Int) {
        ...
        btnEditar.setOnClickListener {
            val intent: Intent = Intent(card.context, EditCityActivity::class.java).apply {
                putExtra("datosCiudad", datosCiudadModel)
            }
            card.context.startActivity(intent)
        }
